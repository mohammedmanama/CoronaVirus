            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.health:
                        ...
                        break;
                    case R.id.image:
                        Intent intent2 = new Intent(MainActivity.this, Image.class);
                        startActivity(intent2);
                        break;
                    case R.id.video:
                        Intent intent3 = new Intent(MainActivity.this, Video.class);
                        startActivity(intent3);
                        break;
                    case R.id.chat:
                        Intent intent4 = new Intent(MainActivity.this, Chat.class);
